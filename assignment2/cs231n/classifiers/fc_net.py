...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        pass1, cache1 = affine_forward(X, self.params['W1'], self.params['b1'])
        pass2, cache2 = affine_forward(pass1, self.params['W2'], self.params['b2'])
        scores = pass2
        pass
        ############################################################################
        #                             END OF YOUR CODE                             #
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dout, grads['W'+ str(self.num_layers)], grads['b' + str(self.num_layers)] = affine_backward(dout, caches_affine.pop())
        grads['W' + str(self.num_layers)] += self.reg * self.params['W' + str(self.num_layers)]
        loss += 0.5 * self.reg * np.sum(self.params['W'+str(self.num_layers)] ** 2) 
        
        for i in range(self.num_layers-2, -1, -1):
            if self.use_dropout:
                dout = dropout_backward(dout, caches_dropout.pop())
            if self.use_batchnorm:
                dout, grads['gamma' + str(i+1)], grads['beta' + str(i+1)] = batchnorm_backward(dout, caches_bn.pop())
            dout, grads['W' + str(i+1)], grads['b' + str(i+1)] = affine_backward(dout, caches_affine.pop())
